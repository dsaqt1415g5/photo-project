...
import edu.upc.eetac.dsa.abaena.photo.api.UserResource;
...
public class PhotoRootAPI {
	@InjectLinks({
		...
		@InjectLink(resource = UserResource.class, style = Style.ABSOLUTE, rel ="users", title="usuarios", type=MediaType2.PHOTO_API_USER),
